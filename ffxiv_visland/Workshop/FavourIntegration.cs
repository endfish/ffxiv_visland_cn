...
public enum FavourMode {
    ...
    None = 0,
    [LocalizedDescription("Keep workshops 1-3, fill 4 with favours", "保留工坊 1–3，用特供填充第 4 工坊")]
    ReplaceWorkshop4 = 1,
    [LocalizedDescription("Try to keep high-value crafts, try same-duration substitutions, sacrifice lowest-value days/workshops", "尽量保留高收益工艺，优先同耗时替换，必要时牺牲最低收益日期或工坊")]
    MinMax = 2,
    [LocalizedDescription("MinMax but use the second rest day for most of the favours", "收益优化，并将大部分特供安排到第二个休息日")]
    MinMaxFreeRestDay = 3,
}
